...
export async function generateMetadata({ params }) {
  try {
    ...
    return buildProjectGalleryMetadata('datapack', params.slug, pack)
  } catch {
...
export default async function DatapackGalleryPage({ params }) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <ContentNavigationWithBanner resource={pack} contentType="datapack" versionsCount={versions.length} galleryCount={gallery.length} projectColor={pack.color} />
