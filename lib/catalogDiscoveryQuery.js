import { disclosureIdsForCatalogHref, appendDisclosureExclusionParams } from '@/lib/disclosureExclusions'
import {
...
export function withCatalogDiscoveryQuery(href, searchParams) {
  ...
  appendDisclosureExclusionParams(params, disclosureIdsForCatalogHref(searchParams, path), path)
