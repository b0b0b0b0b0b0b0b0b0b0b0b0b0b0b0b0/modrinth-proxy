...
import ukCore from './messages/uk.json'
import orvCore from './messages/orv.json'
...
import lvCore from './messages/lv.json'
import svCore from './messages/sv.json'
...
import ukPages from './messages/pages-uk.json'
import orvPages from './messages/pages-orv.json'
...
import lvPages from './messages/pages-lv.json'
import svPages from './messages/pages-sv.json'
...
import ukCatalog from './messages/catalog-uk.json'
import orvCatalog from './messages/catalog-orv.json'
...
import lvCatalog from './messages/catalog-lv.json'
import svCatalog from './messages/catalog-sv.json'
...
const DICTIONARIES = {
  ...
  uk: { ...ukCore, ...ukPages, ...ukCatalog },
  orv: { ...orvCore, ...orvPages, ...orvCatalog },
  ...
  lv: { ...lvCore, ...lvPages, ...lvCatalog },
  sv: { ...svCore, ...svPages, ...svCatalog },
